    ...
    <div class="container">
      <div class="row no-gutters">
        ...
        <div class="column col-12 col-md-6">
          <h2>Cadastre-se para receber novidades e promoções em seu email</h2>
        </div>
        <div class="column col-12 col-md-6">
          <div class="formulario">
            <?php echo do_shortcode('[contact-form-7 id="28" title="Newsletter"]'); ?>
          </div>
      ...
      <div class="row no-gutters">
        <div class="institucional col-12 col-md-6 col-lg-2">
          ...
          <ul>
            ...
            <li><a href="<?php echo home_url(); ?>/quero-ser-distribuidor">Quero ser distribuidor</a></li>
